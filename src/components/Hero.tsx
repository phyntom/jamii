        ...
        <div className="flex flex-col items-center space-y-4 text-center">
          <div className="space-y-2">
            ...
            <p className="mx-auto max-w-[700px] text-gray-500 md:text-xl">
              A secure platform for groups to save money collectively, track contributions, 
              and achieve financial goals as a community.
            </p>
          </div>
          <div className="flex flex-col sm:flex-row gap-4 min-[400px]:gap-2">
            <Button size="lg" className="text-md">Start Saving Free</Button>
