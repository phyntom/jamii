...
const testimonials = [
	{
		quote:
			'Jamii completely transformed how our family savings group operates. The transparency and tracking features have eliminated confusion and disputes.',
	...
	{
		quote:
			'As treasurer for our investment club, Jamii has saved me countless hours of spreadsheet management and payment tracking.',
	...
	{
		quote:
			'The loan module feature on the Standard plan made it possible for our group to help members during financial emergencies while maintaining clear records.',
		author: 'David Chen',
			...
			<div className='container px-4 md:px-6'>
				<div className='text-center mb-12'>
					...
					<p className='mt-4 text-lg text-gray-500 mx-auto max-w-[700px]'>
						Here's what our users are saying about their experience with Jamii.
					</p>
				</div>
